# nomad-example-nomad-plugin

A example of the NOMAD plugin structure.
...
```
pip install dist/nomad-example-nomad-plugin-0.1.0
```
...
### License
Distributed under the terms of the `Apache Software License 2.0`_ license, "nomad-example-nomad-plugin" is free and open source software
